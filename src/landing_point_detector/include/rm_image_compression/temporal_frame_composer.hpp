...
private:
  ...
  void apply_center_color_roi(cv::Mat * frame_bgr) const;
  ...
  double output_fps_ = kDefaultCodecFps;
  double frame_period_sec_ = 1.0 / kDefaultCodecFps;
